...
export default class DataMasking extends SfCommand<DataMaskingResult> {
  ...
  public static readonly flags = {
    ...
    'source-data': Flags.file({char:'d',summary: messages.getMessage('flags.source-data.summary'),required:true, exists: true}),
  ...
  public transform(record: GenericObject, fieldValues: GenericObject): void{
    Object.keys(fieldValues).forEach((fieldName) => {
      ...
      }else if (value === 'name'){ // generate random string
