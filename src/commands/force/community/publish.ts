...
export default class CommunityPublish extends SfdxCommand {
    ...
    `$ deloitte force:community:publish -n "Customer_Community" -u myorg`,
    ];
    ...
    public async run() {
        ...
        try{
            ...
            var results:any = await this.publishRequest(accessToken,instanceUrl,community.result.records[0].Id);
