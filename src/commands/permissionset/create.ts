  ...
  public async run(): Promise<PermissionSetCreateResult> {
    ...
    try {
      ...
      if (result.customMetadataTypeAccesses)
        permissionSet.customMetadataTypeAccesses = result.customMetadataTypeAccesses;
      ...
      if (result.externalDataSourceAccesses)
        permissionSet.externalDataSourceAccesses = result.externalDataSourceAccesses;
