...
export default class DataMasking extends SfdxCommand {
    ...
    public static examples = [
        `deloitte force:data:bulk:query -u devhub -q "select id from Account"
        deloitte force:data:masking -f config/data-masking-def.json -o Account -s bulk_output/ACCOUNT.csv
