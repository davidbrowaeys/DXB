...
type FieldSetCreateResult = {
  output: string;
}

Messages.importMessagesDirectory(__dirname);
const messages = Messages.loadMessages('dxb', 'object.fieldset');
export default class FieldSetCreate extends SfCommand<FieldSetCreateResult> {
  ...
  public static readonly flags = {
    ...
    'fieldset-name': Flags.string({char: 'n',summary: messages.getMessage('flags.fieldset-name.summary'),required:true}),
